...
public class J3DJBox extends Applet implements MouseListener, MouseMotionListener {
    ...
    public void getScene() {
        ...
        box = new Box(.5f, .5f, .5f, Primitive.GENERATE_TEXTURE_COORDS, getAppearance(new Color3f(Color.green)));
