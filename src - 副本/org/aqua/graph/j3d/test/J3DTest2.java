...
public class J3DTest2 {
    ...
    public BranchGroup createGraph() {
        ...
        System.out.println(sphere.getBounds());
        ...
        BoundingBox box = new BoundingBox(sphere.getBounds());
        ...
        box.getLower(lp);
        box.getUpper(up);
        for (double z = lp.z / 2; z < up.z / 2; z += threshold) {
            for (double y = lp.y / 2; y < up.y / 2; y += threshold) {
                for (double x = lp.x / 2; x < up.x / 2; x += threshold) {
                    Point3d lb1 = new Point3d(x, y, z);
                    Point3d ub1 = new Point3d(x + threshold, y + threshold, z + threshold);

                    Box b = new Box(threshold, threshold, threshold, ap);

                    Shape3D s = b.getShape(Box.BACK);
        ...
        float r = threshold;
        Point3f[] shapeCoordinates = { new Point3f(-r, r, r), // point
                                                              // 0
                                                              // (Face
                                                              // a -
                                                              // top
                                                              // -ACw)
                new Point3f(r, r, r), // point 1
                new Point3f(r, r, -r), // point 2
                new Point3f(-r, r, -r), // point 3

                new Point3f(-r, -r, r), // point 4 (Face b - bottom
                                        // -Cw)
                new Point3f(r, -r, r), // point 5
                new Point3f(r, -r, -r), // point 6
                new Point3f(-r, -r, -r), // point 7

                new Point3f(-r, r, r), // point 0 (Face c - front -
                                       // ACw)
                new Point3f(-r, -r, r), // point 4
                new Point3f(r, -r, r), // point 5
                new Point3f(r, r, r), // point 1

                new Point3f(r, r, -r), // point 2 (Face d - back - Cw)
                new Point3f(-r, r, -r), // point 3
                new Point3f(-r, -r, -r), // point 7
                new Point3f(r, -r, -r), // point 6

                new Point3f(-r, r, r), // point 0 (Face e - left - ACw)
                new Point3f(-r, r, -r), // point 3
                new Point3f(-r, -r, -r), // point 7
                new Point3f(-r, -r, r), // point 4

                new Point3f(r, r, r), // point 1 (Face f - right side -
                                      // Cw)
                new Point3f(r, r, -r), // point 2
                new Point3f(r, -r, -r), // point 6
                new Point3f(r, -r, r), // point 5
        ...
        qs.setCoordinates(0, shapeCoordinates);
